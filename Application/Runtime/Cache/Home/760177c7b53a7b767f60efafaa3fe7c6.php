...
<body>
	<div id="adetail-img">
		<img src="/collegial/Public/images/actdetail.png" alt="">
	</div>
	<div id="adetail-body">
		<p>蒙牛校园全明星~早间青春SHOW</p>
		<div class="detail-info">
			<ul>
				...
				<li class="clearfix">
					<span>活动时间</span>
					<p>2016.9.2 - 2016.9.29</p>
				</li>
				<li class="clearfix">
					<span>活动地点</span>
					<p>浙江省杭州市临安市环城北路88号</p>
				</li>
				<li class="clearfix">
					<span>活动费用</span>
					<p>免费</p>
		...
		<div id="adetail-intro" class="pre-navbt">
			<span>浙江省杭州市临安市环城北路88号浙江省杭州市临安市环城北路88号浙江省杭州市临安市环城北路88号浙江省杭州市临安市环城北路88号浙江省杭州市临安市环城北路88号</span>
		</div>
	</div>
